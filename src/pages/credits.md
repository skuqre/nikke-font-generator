...
| [**Docteur Atomic**](https://www.dafont.com/docteur-atomic.font) | Made by Jonathan Paquette. Used on Logo Generator. Found through research.<br>*This site uses a modified version of the font that removes all the erosion.* |
...
| [**PSL Imperial Extra**](http://www.fontpsl.com/webpage/myfont/show.php?id=47/) | Made by [Font PSL](http://www.fontpsl.com/). Used as the fonts for the Thai language. |
